...
export default function HowItWorks() {
  const steps = [
    ...
    {
      title: "انتخاب ملک و بررسی فرصت  هاسرمایه گذاری ",
      description:
        "پروژه  دلخواه خود را انتخاب و به صورت دقیق و کامل میتوانید مقایسه کنید و به اندازه نیاز سرمایه‌گذاری کنید.",
      icon: <FaMap className="w-5 h-5 text-white" />,
    },
    {
      title: " پرداخت امن وآسان",
      description: "سرمایه‌گذاری شما از طریق درگاه بانکی معتبر انجام می‌شود.",
      icon: <FaCreditCard className="w-5 h-5 text-white" />,
    },
    {
      title: "دریافت مدارک مالکیت",
      description: "مدارک و گواهی مالکیت شما زیر نظر مراجع قانونی صادر میشود",
