...
export default function InvestmentOpportunities() {
  const projects = [
    ...
    {
      id: 2,
      title: "پروژه 300 واحدی شهرک غرب",
    ...
    {
      id: 4,
      title: " پروژه تجاری 400 واحدی الهیه",
          ...
          {projects.map((project) => (
            ...
            >
              <div className="relative h-48 overflow-hidden rounded-t-xl">
                ...
                />
                <div className="absolute bottom-2 right-2 bg-green-400 text-xs font-semibold px-2 py-1 rounded">
              ...
              <div className="p-5">
                ...
                <div className="mb-3">
                  <div className="w-full bg-gray-200 rounded-full h-2.5">
                    <div
                      className="bg-[#FFED29] h-2.5 rounded-full"
                ...
                <Link
                  ...
                  className="block w-full text-center py-2 px-4 bg-green-400 hover:bg-green-500 text-gray-900 font-medium rounded-md transition"
                >
                  سرمایه‌گذاری کنید
                </Link>
              </div>
