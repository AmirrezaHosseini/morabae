...
export default function ProfitProjection() {
  ...
  const calculateReturn = (years: number) => {
    return investment * Math.pow(1 + 0.3, years);
  };
  ...
  return (
    <section className="py-4 md:py-20 bg-gradient-to-b from-gray-50 to-green-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-8 text-gray-600 max-w-2xl mx-auto">
          <p>
            سود فوق بر اساس بازدهی متوسط سالانه <strong>30%</strong> محاسبه شده
